...
#use this ver. if your file format is .MRC.
#The autopick step can be skiped by set the do_gautopick parameter to NO
#BUT then the Gctf 'GCTF_ExtraPar' need to change.
#####************************************************************************************#####

#Requirement: EMAN2, e2proc3d.py; Motioncorr2.1; Gctf; Gautomatch; Cuda libriary; High-end GPUs;  MRC file format;
...
#else if ( ! -f $Templates ) then						###### untick the '#' if you have a template for autopicking #######
